Training the model with different sizes of latent dimensions yielded different results, in different aspects of the task the model had. Below can we see of the loss differ from each other: \\
